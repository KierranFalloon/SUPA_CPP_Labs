...
###################
*/
void NormalDistributionFunction::setMu(double mu) {m_mu = mu;};
void NormalDistributionFunction::setSigma(double sigma) {m_sigma = sigma;};
...
###################
*/
double NormalDistributionFunction::mu() {return m_mu;};
double NormalDistributionFunction::sigma() {return m_sigma;};
...
###################
*/
void NegativeCrystalBallDistribution::setxbar(double xbar) {m_xbar = xbar;};
void NegativeCrystalBallDistribution::setSigma(double sigma) {m_sigma = sigma;};
void NegativeCrystalBallDistribution::setAlpha(double alpha) {m_alpha = alpha;};
void NegativeCrystalBallDistribution::setN(double n) {m_n = n;};
...
###################
*/
double NegativeCrystalBallDistribution::xbar() {return m_xbar;};
double NegativeCrystalBallDistribution::sigma() {return m_sigma;};
double NegativeCrystalBallDistribution::alpha() {return m_alpha;};
double NegativeCrystalBallDistribution::n() {return m_n;};
